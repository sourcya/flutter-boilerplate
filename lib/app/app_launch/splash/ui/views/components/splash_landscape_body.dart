...
class SplashLandscapeBody extends GetView<SplashController> {
  const SplashLandscapeBody({super.key});
    ...
    return Obx(() {
      ...
      return Stack(
        children: [
          SafeArea(
            child: Padding(
              padding: context.paddingSymmetric(horizontal: 44, vertical: 24),
              child: Column(
                children: [
                  Expanded(
                    child: Center(
