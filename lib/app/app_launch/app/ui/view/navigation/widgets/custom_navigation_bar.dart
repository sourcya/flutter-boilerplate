...
/// A Material 3 [CustomNavigationBar] destination.
///
/// Displays a label below an icon. Use with [CustomNavigationBar.destinations].
///
/// See also:
///
...
class CustomNavigationDestination extends NavigationDestination {
  ...
  /// in the [CustomNavigationBar.destinations].
  ...
  @override
  Widget build(BuildContext context) {
    final _NavigationDestinationInfo info = _NavigationDestinationInfo.of(
      context,
    );
...
class _NavigationDestinationBuilder extends StatefulWidget {
  /// Builds a destination (icon + label) to use in a Material 3 [CustomNavigationBar].
  ...
  /// Builds the icon for a destination in a [CustomNavigationBar].
  ///
  ...
  /// Builds the label for a destination in a [CustomNavigationBar].
  ///
  /// To animate between unselected and selected, build the icon based on
...
/// Inherited widget for passing data from the [CustomNavigationBar] to the
/// [CustomNavigationBar.destinations] children widgets.
///
...
/// Selection Indicator for the Material 3 [CustomNavigationBar] and [NavigationRail]
/// components.
///
