...
final _entities = <obx_int.ModelEntity>[
  obx_int.ModelEntity(
    id: const obx_int.IdUid(1, 5360530487038633694),
    name: 'DatabaseWishlistItem',
    lastPropertyId: const obx_int.IdUid(4, 4603870655289997619),
    flags: 0,
    properties: <obx_int.ModelProperty>[
      obx_int.ModelProperty(
        id: const obx_int.IdUid(1, 1426730170099266341),
        name: 'id',
        type: 6,
        flags: 129,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(2, 5145188807558010170),
        name: 'name',
        type: 9,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(3, 255030732230360003),
        name: 'imageUrl',
        type: 9,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(4, 4603870655289997619),
        name: 'date',
        type: 10,
        flags: 0,
      ),
...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
    ...
    entities: _entities,
    lastEntityId: const obx_int.IdUid(1, 5360530487038633694),
...
class DatabaseWishlistItem_ {
  ...
  static final name = obx.QueryStringProperty<DatabaseWishlistItem>(
    _entities[0].properties[1],
  );

  /// See [DatabaseWishlistItem.imageUrl].
  static final imageUrl = obx.QueryStringProperty<DatabaseWishlistItem>(
    _entities[0].properties[2],
  );

  /// See [DatabaseWishlistItem.date].
  static final date = obx.QueryDateProperty<DatabaseWishlistItem>(
