...
class AppColors {
  ...
  static const Color primaryLight = blueMain;
  static const Color secondaryLight = purpleMain;
  static const Color backgroundLight = white;
  static const Color surfaceLight = white;
  static const Color errorLight = redMain;
  ...
  //DARK
  static const Color primaryDark = blueLighterMain;
  static const Color secondaryDark = purpleLighterMain;
  static const Color backgroundDark = darkGrey;
  static const Color surfaceDark = darkGrey;
  static const Color errorDark = redLight;
  static const Color appBarDark = darkGrey;
