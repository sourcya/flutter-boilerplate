...
class EnvManger {
   ...
   Future<String> get sentryKey => PlayxEnv.getString(_sentryKey);
    ...
    Future<String> get googleSignIosInClientId => PlayxEnv.getString(_googleSignIosInClientId);

    Future<String> get googleSignWebInClientId => PlayxEnv.getString(_googleSignWebInClientId);

   Future<String> get testWishlistEnv=> PlayxEnv.getString('test_wishlist_env_key',fallback:  'Wishlist Env Fallback');
