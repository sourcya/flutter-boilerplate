...
class __$$SuccessCopyWithImpl<T, $Res>
    extends _$NetworkResultCopyWithImpl<T, $Res, _$Success<T>>
...
class __$$ErrorCopyWithImpl<T, $Res>
    extends _$NetworkResultCopyWithImpl<T, $Res, _$Error<T>>
...
class _$Error<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'NetworkResult<$T>.error(exception: $exception)';
  }
...
abstract class Error<T> implements NetworkResult<T> {
  const factory Error(final NetworkExceptions exception) = _$Error<T>;
